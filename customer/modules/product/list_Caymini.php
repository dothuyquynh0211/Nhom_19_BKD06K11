<?php 
$title="Cay canh mini || Chun Garden" ;
require_once ('layout/headerCus.php');
?>

<?php  
$sql="SELECT id_Product, Name,Price,image FROM Product WHERE id_Categorize = 9 ";
$kw="";
if(isset($_GET['kw'])){
	$kw=$_GET['kw'];
...
//phân trang
$sqli="SELECT COUNT(`id_Product`) AS 'tongSp' FROM product WHERE id_Categorize=9 AND Name LIKE '%$kw%'";
...
?>
	...
	<div class="search">
		<form class="content_search">
			...
			<input type="hidden" name="action" value="list_Caymini">
			<input type="text" name="kw" placeholder="Bạn cần tìm kiếm...">
			<button type="submit" ><i class="fas fa-search"></i></button>
			</form>
	</div>
	
	<div class="box"><h2>Cây cảnh mini</h2>
		<table>
			<?php 
